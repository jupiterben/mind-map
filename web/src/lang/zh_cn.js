export default {
  ...
  ai: {
    ...
    minimaxConfigTip: '使用 MiniMax 官方 API，请到 platform.minimax.io 获取 API Key。',
    ...
    aiNoteDetailPrompt:
      '以下为思维导图中从根到当前节点的路径：{path}。请为该节点（最后一节）生成一段详细说明或备注，使用 Markdown 格式，便于理解与扩展。只返回备注内容，不要其他解释。',
    aiCreatePartPromptTip: '已根据从根到当前节点的路径自动生成提问，可直接确认或修改后确认。',
    aiCreatePartPromptPlaceholder: '用于向 AI 提问的完整内容',
    aiCreatePart: 'AI子节点',
    aiContinueToolbarTitle: 'AI子节点',
    breadth: '数量',
    breadthAuto: '自动',
    aiCreatePartBreadth: '子节点约 {breadth} 个。',
    toolbarHintCreateAll: '一键生成思维导图',
    toolbarHintNoteDetail: 'AI 详细：为节点生成备注',
    toolbarHintCreatePart: 'AI子节点（需选中一个节点）\nCtrl+Enter 替换子节点，Ctrl++ 添加子节点',
    toolbarHintBreadth: '数量（AI子节点时约生成多少个子节点）',
    debugTitle: 'AI 调试',
    debugPrompt: '提示词',
    debugResponse: 'AI 返回',
    debugClear: '清除',
    ...
    debugSmartIconTitle: '智能图标',
    debugSmartIconPlaceholder: '输入节点文本',
    debugSmartIconSend: '测试智能图标',
